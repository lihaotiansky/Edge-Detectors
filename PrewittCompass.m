function g=PrewittCompass(f)
%PREWITTCOMPASS Find edges in gray images with set of 8 kernels is produced
%by taking prewitt operator and rotating its coefficients circularly
